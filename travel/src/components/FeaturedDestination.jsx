...
function FeatureDestination(){
    ...
    return(
        ...
        <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20">
           ...
           <Title title='Featured Destination' subTitle=' Our Featured Destination highlights the most popular and highly recommended hotel stays, offering comfort, convenience, and excellent service for a memorable travel experience.'/>
