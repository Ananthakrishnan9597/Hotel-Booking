...
function MyBookings(){
   ...
   const [bookings, setBookings] = useState(userBookingsDummyData)
    ...
    return(
        <>
           <div className="py-28 md:pb-35 md:pt-32 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32">
            <Title title='My Bookings' subTitle='TravelNest helps you find the perfect place to stay wherever you go.
            From luxury hotels to budget-friendly rooms, we offer options for every traveler.' align='left'/>
           <div className="max-w-6xl mt-8 w-full text-gray-800">
            <div className="hidden md:grid md:grid-cols-[3fr_2fr_1fr_] w-full border-b border-gray-300 font-medium text-base py-3">
                  ...
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4">
                        ...
                        <div className="flex items-center gap-1 text-sm text-gray-500">
                         ...
                         <div className="flex items-center gap-1 text-sm text-gray-500">
                            <img src={assets.guestsIcon} alt="guests-icopn" />
